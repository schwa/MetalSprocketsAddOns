...
public struct Mesh {
    ...
    public struct Submesh {
        ...
        public var indices: Buffer

        public init(label: String? = nil, primitiveType: MTLPrimitiveType, indices: Buffer) {
            self.label = label
    ...
    public struct Buffer {
        ...
        public init(buffer: MTLBuffer, count: Int, offset: Int) {
            self.buffer = buffer
            self.count = count
            self.offset = offset
        }
    ...
    public init(label: String? = nil, submeshes: [Submesh], vertexDescriptor: VertexDescriptor, vertexBuffers: [Buffer]) {
        self.label = label
